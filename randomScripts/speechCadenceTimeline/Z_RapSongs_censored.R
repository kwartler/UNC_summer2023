...
folderPath  <- '~/Desktop/UNC_summer2023/randomScripts/speechCadenceTimeline/z_rap_songs_revised/shortenedSongNames'
...
eminemSongs <- c(TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE,
