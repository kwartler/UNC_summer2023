...
# Data
candidates <- read.csv('https://raw.githubusercontent.com/kwartler/UNC_summer2023/main/lessons/E_syntaticParsing_AI-Ethics/data/HR%20Hiring%20(Bias%20%26%20Fairness).csv')
...
#saveRDS(plan, '~/Desktop/UNC_summer2023/personalFiles/variable_treatment_plan.rds')
#plan <- readRDS('~/Desktop/UNC_summer2023/personalFiles/variable_treatment_plan.rds')
...
candidateFit <- cv.glmnet(as.matrix(allCandidateData),
                          ...
                          nfolds=3,
                          intercept=F)
#saveRDS(candidateFit, '~/Desktop/UNC_summer2023/personalFiles/candidateFit.rds')
